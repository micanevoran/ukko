...
(async () => {
  const inputHtml = path.resolve(__dirname, "Lista de precios", "ukko-lista-precios.html");
  const outputPdf = path.resolve(__dirname, "Lista de precios", "ukko-lista-precios.pdf");
